    ...
    <label :class="wrapClasses">
        <span :class="checkboxClasses">
            <span :class="innerClasses">
                <span class="icon-wrap" v-if="type!=='button'">
                    <Icon v-if="!currentValue" :type="iconType[0]" :size="size"></Icon>
                    <Icon v-if="currentValue" :type="iconType[1]" :size="size"></Icon>
                </span>
            </span>
            <input
                v-if="group"
    ...
    export default {
        ...
        props: {
            ...
            iconType:{
                type:Array,
                default(){
                    return ['android-checkbox-outline-blank','android-checkbox']
                }
            },
            name: {
                type: String
