            ...
            <div :style="circleStyles">
                <svg :viewBox="circleBox">
                    ...
                    <g>
                        ...
                        <circle :cx="circlec" :cy="circlec" :r="radius" :stroke-linecap="(!!strokeLinecap)?strokeLinecap:((percent!==0)?'round':'butt')" :stroke-width="strokeWidth" :stroke="color" fill="none" :transform="'matrix(0,-1,1,0,0,'+size+')'" :stroke-dasharray="dashArray"></circle>
